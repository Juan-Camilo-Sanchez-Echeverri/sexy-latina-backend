...
const URL = `${envs.frontPublicUrl}/reset-password`;
...
export const recoverPassword = (data: Data) => {
  ...
  return `
    ...
    <body style="margin:0;padding:0;background-color:#ffffff;font-family:'Poppins', Arial, Helvetica, sans-serif;">
      <div style="display:none;max-height:0px;overflow:hidden;">Recupera tu contraseña en Sexy Latina</div>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
              <tr>
                <td style="padding:16px 30px;color:#555;font-size:15px;line-height:20px;text-align:center;">
                  ...
                  Sabemos que a veces olvidar la contraseña puede pasar,</p>
                  <p style="margin:0 0 8px 0;font-size:15px;line-height:20px;font-weight:400;color: #000000;">no te preocupes, estamos aquí para ayudarte.</p>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                          <tr>
                            <td bgcolor="#A07FF8" style="border-radius:5px; text-align:center;">
                              <a href="${URL}?email=${email}&token=${token}" target="_blank" style="display:block;width:100%;padding:12px 0;color:#ffffff;text-decoration:none;font-weight:bold;">Validar identidad</a>
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <p style="margin:12px 0 4px 0;color: #8A8A8E;font-size:10px;line-height:15px;font-weight:400;text-align:center;">Si no solicitaste este cambio, simplemente ignora este mensaje.</p>
                  <p style="margin:0 0 0 0;color: #8A8A8E;font-size:10px;line-height:15px;font-weight:400;text-align:center;">Tu cuenta seguirá segura.</p>
