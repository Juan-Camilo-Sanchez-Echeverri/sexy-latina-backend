...
export const activateAccountTemplate = (data: Data) => {
  ...
  return `
    ...
    <body style="margin:0;padding:0;background-color:#ffffff;font-family:'Poppins', Arial, Helvetica, sans-serif;">
      <div style="display:none;max-height:0px;overflow:hidden;">Activa tu cuenta en Sexy Latina</div>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
              <tr>
                <td style="padding:16px 30px;color:#555;font-size:15px;line-height:20px;text-align:center;">
                  ...
                  <p style="margin:0 0 8px 0;font-size:15px;line-height:20px;font-weight:400;color: #000000;">Para completar tu registro y empezar a disfrutar de Sexy Latina, por favor activa tu cuenta.</p>
                  ...
                  <p style="margin:12px 0 4px 0;color: #8A8A8E;font-size:10px;line-height:15px;font-weight:400;text-align:center;">Si no te registraste en Sexy Latina, simplemente ignora este mensaje.</p>
