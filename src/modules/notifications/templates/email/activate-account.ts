...
export const activateAccountTemplate = (data: Data) => {
  ...
  const activationUrl = `${envs.frontPublicUrl}/activate-account?email=${encodeURIComponent(email)}&token=${encodeURIComponent(token)}`;
  ...
  return `
    ...
    <body style="margin:0;padding:0;background-color:#ffffff;font-family:'Poppins', Arial, Helvetica, sans-serif;">
      <div style="display:none;max-height:0px;overflow:hidden;">Activate your account on Sexy Latina</div>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
              <tr>
                <td style="padding:16px 30px;color:#555;font-size:15px;line-height:20px;text-align:center;">
                  ...
                  <p style="margin:16px 0 8px 0;font-size:15px;line-height:20px;font-weight:400;color: #000000;">We're so happy to have you with us!</p>
                  <p style="margin:0 0 8px 0;font-size:15px;line-height:20px;font-weight:400;color: #000000;">To complete your registration and start enjoying Sexy Latina, please activate your account.</p>
                  <p style="margin:16px 0 8px 0;font-size:15px;line-height:20px;font-weight:400;color: #000000;">Click the button below:</p>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                          <tr>
                            <td bgcolor="#A07FF8" style="border-radius:5px; text-align:center;">
                              <a href="${activationUrl}" target="_blank" style="display:block;width:100%;padding:12px 0;color:#ffffff;text-decoration:none;font-weight:bold;">Activate account</a>
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <p style="margin:0 0 12px 0;font-size:11px;line-height:16px;text-align:center;word-break:break-all;">
                    <a href="${activationUrl}" target="_blank" style="color:#A07FF8;text-decoration:underline;">${activationUrl}</a>
                  </p>

                  <p style="margin:12px 0 4px 0;color: #8A8A8E;font-size:10px;line-height:15px;font-weight:400;text-align:center;">If you didn't sign up for Sexy Latina, simply ignore this message.</p>
